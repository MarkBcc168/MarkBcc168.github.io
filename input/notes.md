...
{{notes("Commutative Algebra",
     [], 
     {"pdf" : "static/notes/commalg.pdf"},
...
{{notes("Cayley's Tree Formula", [],
    {"pdf" : "static/notes/cayley.pdf"},
...
{{notes("Power Reciprocity Law", [],
    {"pdf" : "static/notes/gauss_sum.pdf"},
...
{{notes("Desargues Involution Theorem", [],
    {"pdf" : "static/notes/ddit.pdf", 
...
Here are notes or slides from my other presentations. Talks directly related to my papers are linked at [my research page](research.html).

{{notes("Secrets of Elliptic Curves", [],
    {"slides" : "static/notes/elliptic_curves_talk.pdf"},
